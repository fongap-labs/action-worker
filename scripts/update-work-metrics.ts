...
[![Task Dispatch](https://img.shields.io/badge/Task%20Dispatch-${badgeValue(counts.dispatch)}-4B6F8C?style=flat-square&labelColor=68727E)](https://github.com/${repository}/actions) [![AI Review](https://img.shields.io/badge/AI%20Review-${badgeValue(counts.ai_review)}-7A6853?style=flat-square&labelColor=68727E)](https://github.com/${repository}/actions) [![PR Governance](https://img.shields.io/badge/PR%20Governance-${badgeValue(counts.pr_governance)}-3F5A78?style=flat-square&labelColor=68727E)](https://github.com/${repository}/actions) [![Release Governance](https://img.shields.io/badge/Release%20Governance-${badgeValue(counts.release_governance)}-4E756E?style=flat-square&labelColor=68727E)](https://github.com/${repository}/releases) [![Status](https://img.shields.io/github/actions/workflow/status/${repository}/validate-ci.yml?branch=main&style=flat-square&label=Status&labelColor=68727E)](https://github.com/${repository}/actions/workflows/validate-ci.yml)
<!-- work-metrics:end -->`;
