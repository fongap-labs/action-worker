...
[![Task Dispatch](https://img.shields.io/badge/Task%20Dispatch-${badgeValue(counts.dispatch)}-4F6B82?style=flat-square&labelColor=6B7280)](https://github.com/${repository}/actions) [![AI Review](https://img.shields.io/badge/AI%20Review-${badgeValue(counts.ai_review)}-5C6670?style=flat-square&labelColor=6B7280)](https://github.com/${repository}/actions) [![PR Governance](https://img.shields.io/badge/PR%20Governance-${badgeValue(counts.pr_governance)}-455D73?style=flat-square&labelColor=6B7280)](https://github.com/${repository}/actions) [![Release Governance](https://img.shields.io/badge/Release%20Governance-${badgeValue(counts.release_governance)}-4F716B?style=flat-square&labelColor=6B7280)](https://github.com/${repository}/releases) [![Status](https://img.shields.io/github/actions/workflow/status/${repository}/validate-ci.yml?branch=main&style=flat-square&label=Status&labelColor=6B7280)](https://github.com/${repository}/actions/workflows/validate-ci.yml)
<!-- work-metrics:end -->`;
