...
[![Task Dispatch](https://img.shields.io/badge/Task%20Dispatch-${badgeValue(counts.dispatch)}-4E7391?style=flat-square&labelColor=747D87)](https://github.com/${repository}/actions) [![AI Review](https://img.shields.io/badge/AI%20Review-${badgeValue(counts.ai_review)}-806B57?style=flat-square&labelColor=747D87)](https://github.com/${repository}/actions) [![PR Governance](https://img.shields.io/badge/PR%20Governance-${badgeValue(counts.pr_governance)}-465F7C?style=flat-square&labelColor=747D87)](https://github.com/${repository}/actions) [![Release Governance](https://img.shields.io/badge/Release%20Governance-${badgeValue(counts.release_governance)}-4F766B?style=flat-square&labelColor=747D87)](https://github.com/${repository}/releases) [![Status](https://img.shields.io/github/actions/workflow/status/${repository}/validate-ci.yml?branch=main&style=flat-square&label=Status&labelColor=747D87)](https://github.com/${repository}/actions/workflows/validate-ci.yml)
<!-- work-metrics:end -->`;
